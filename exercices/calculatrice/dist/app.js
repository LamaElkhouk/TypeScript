...
const inputCalculatrice = document.querySelector(".todo-input");
let resultat = []; //tableau pour stocker le calcul
...
touches.forEach(element => {
    ...
    button_calculatrice.addEventListener('click', function (e) {
